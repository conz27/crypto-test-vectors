...
def genls(id, i, la_id, ls_im1, prefix="ls"):
    if i == 0:
        ...
        print("SHA-256 input (256 bits) = la_id" + str(id) + " (16-bit) || " + prefix + str(id) + "(" + str(
            i - 1) + ")" + " (128-bit) || 0 (112-bit) = ")
        ...
        print("SHA-256 output (256 bits) = SHA-256(la_id" + str(id) + " || " + prefix + str(id) + "(" + str(
            i - 1) + ")) || 0^{112}) =")
        ...
        print(prefix + str(id) + "(" + str(i) + ") = AES key (128 bits) = first 128 bits of SHA-256(la_id" + str(
            id) + " || " + prefix + str(id) + "(" + str(i - 1) + ")) =")
